<section class="production">
    <div class="production__container container">
        <?php
        if ($production_block_title) {
            echo '<div class="separator"></div>';
            echo '<h2 class="production__title title title_h2">' . $production_block_title . '</h2>';
        }
        ?>
        <div class="production__cards">
            ...
            <a href="/contacts/bithim.php" class="production__card">
                <div class="production__content">
            ...
            <a href="/contacts/dezinfect.php" class="production__card">
                <div class="production__content">
